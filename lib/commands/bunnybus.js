...
Args
    ...
    .option('-d, --duration <n>', 'set a runtime duration for subscribe to close with in milliseconds. defaults to 0 for infinite', parseInt)
    .parse(process.argv);
